    ...
    ,afterDisplay: function(item,containerid,symbol) {
		...
		if(!prx.editor) {
            ...
            $('#'+_id+'-checkbox').on('change.custom-change-event', function(e, updateStatus){
                ...
                var previousValue = prx.currentPlayerStatus.helper.get(_id, 'active');
                ...
                prx.currentPlayerStatus.helper.set(_id, 'active', !previousValue);
            });
                ...
                if(item.vertical) {
                    ...
                    prx.draggable._draggables['#'+_id+' .slider-button'] = Draggable.create('#'+_id+' .slider-button', {
                        ...
                        onDragEnd: function(){
                            ...
                            prx.currentPlayerStatus.helper.set(_id, 'sliderLeft', _left);
                            prx.currentPlayerStatus.helper.set(_id, 'sliderRight', _right);
                ...
                if(item.vertical) {
                    prx.draggable._draggables['#'+_id+' .slider-button'] = Draggable.create('#'+_id+' .slider-button', {
                        ...
                        onDragEnd: function(){
                            ...
                            prx.currentPlayerStatus.helper.set(_id, 'sliderRight', progress);
